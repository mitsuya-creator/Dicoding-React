...
function CardList() {
    return (
        <div className="card">
            <h1>Babel</h1>
            <small>Kamis, 14 April 2022</small>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur quo alias nesciunt optio a delectus deleniti consequatur nam possimus! Veritatis, placeat quae illo qui eius debitis est enim. Quis, iste!
            </p>
            <div className="flex-justify-around container-icon-button">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="archive-icon">
